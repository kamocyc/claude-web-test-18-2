...
export class Economy {
   ...
   * 初期資金。
   *
   * 道路が入るまでは 250,000 だった。1 本通すと土工・トンネル・橋・舗装で
   * 20-30 万かかり、そのうえトンネルの支保 (2 m ごとに 900-11,000 円) が
   * 乗るので、旧来の額では**線形を引く前に詰む**。
   * 「調査に金をかけるか、勘で掘って事故るか」が判断として残る程度には
   * 苦しく、道路 1 本は通せる額として 450,000 にしてある。
   */
  money = 450_000;
  /** 残土 [m^3]。 */
  spoil = 0;
